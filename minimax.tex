...
\begin{proof}
  ...
  Let $A_1,B_1$ be a cover, we claim that $A \sm \big(A_1\cup f^{-1}[B_1]\big)$ is an antichain.
  ...
  Therefore, by K\H{o}nig's Theorem there is a matching $A'',B''$ of cardinality $|A''|\ge |A_1\cup B_1|$. Hence $|A''|\ge |A\sm A'|$.
