...
\begin{proof}
   ...
   \ceq{\hfill|B'|}{=}{\bigg|\bigcup_{b\in B'}\phi(A';b')\bigg|}

   \ceq{}{\subseteq}{\bigg|\bigcup_{b\in B'}\phi(A\,;b')\bigg|.}
   ...
   \item[b.]
   Suppose instead that, for some $B'\subseteq B$, \ssf{2} holds with equality.
   Define

   \ceq{\hfill A'}{=}{\bigcup_{b\in B'}\phi(A\,;b)}
   ...
   To prove the claim assume that there is a set $B''\subseteq B$ that contradicts \ssf{2}, then

   \ceq{\hfill\bigg|\bigcup_{b\in B''}\phi(A{\sm} A';\,b)\bigg|}{<}{|B''|.}

   By the definition of $A'$

   \ceq{\hfill A'\ \cup\ \bigcup_{b\in B}\phi(A{\sm} A';b)}{=}{ A'\cup\bigcup_{b\in B''}\phi(A\,;b)}

   \ceq{}{=}{\bigcup_{b\in B'\cup B''}\phi(A\,;b)}

   Hence 

   \ceq{\hfill\bigg|\bigcup_{b\in B'\cup B''}\phi(A\,;b)\bigg|}{=}{|A'|+|B''|}

   As $|A'|=|B'|$ by the choice of $B'$, this contracticts the assumption that $B$ satisfies \ssf{2}.
...
\begin{proof}
   ...
   The second is proved by the symmetric argument (using \ssf{3} for \ssf{2} of the fact above). 
