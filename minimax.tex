...
\begin{proof}
   ...
   \ceq{\hfill|B'|\medrel{=}\bigg|\bigcup_{b\in B'}\phi(A';b')\bigg|}{\subseteq}{\bigg|\bigcup_{b\in B'}\phi(A\,;b)\bigg|.}
   ...
   \ceq{}{=}{\phantom{\bigcup_{b\in B'}\phi(A\,;b)}\llap{$A'$\kern4ex}\ \ \cup\ \ \bigcup_{b\in B''}\phi(A\,;b)}

   \ceq{}{=}{\phantom{\bigcup_{b\in B'}\phi(A\,;b)}\llap{$A'$\kern4ex}\ \ \cup\ \ \bigcup_{b\in B''}\phi(A{\sm} A'\,;b)}
