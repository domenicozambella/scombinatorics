...
\begin{proof}
  ...
  Second, we apply the same argument shows that $\phi(A'\,;B{\sm} B')^{\rm op}$ has a  set of distinct representatives $B_1\subseteq B\sm B'$.
  Hence $A',B_1$ is a matching.
  Then $(A_1\cup A'),\ (B'\cup B_1)$ is a matching of  $\phi(A\,;B)$.
  The cardinality of this matching is $|A_1|+|A'|=|B'|+|B_1|=|B'|+|A'|$.
