...
Let $F$ be the $\{0,1\}$-valued matrix $\Indicator_{\phi(a_i,b_j)}$.
...
\ceq{\hfill\tau^*}{=}{\inf\,\big\{\,1_m^{\rm T}\;x\ :\ F^{\rm T}\,x\ge 1_n,\ 0\le x\};}

\ceq{\hfill\nu^*}{=}{\sup\big\{\,1_n^{\rm T}\ y\,\  :\ \ F\,y\le 1_m,\,\  0\le y\}.}
...
\begin{theorem}[(p,q)-Theorem (Alon, Kleitman + Matou\v{s}ek)]
