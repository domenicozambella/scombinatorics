...
Throughout this section we work with some fixed formula $\phi(x\,;z)$ and with a the family of definable subsets $\phi(\Omega\,;b)_{b\in\V}$ that are events of the sample space $\Omega,\Pr$.
