...
This will be used to find a bound to

\ceq{\hfill\Pr\Big(\big|\Fr(S,A) - \Pr(A)\big|\ge\epsilon\Big)}
  {}
  {}

which is immediately seen to be equal to the probability in (1).
...
\begin{proof}
 ...
 which, by the Weak Law of Large Numbers~\ref{WLLN_exp}, 
  ...
  {=}
  {\Pr\bigg(\Big|\sum_{i=1}^n\Indicator_{S_i,b} - \Indicator_{S'_i,b}\Big|\ge\frac{n\epsilon}2\bigg)}
  \smallskip
  ...
  \ceq{\hfill}
  {=}
  {\Pr\bigg(\Big|\sum_{i=1}^n\sigma_i\big(\Indicator_{S_i,b} - \Indicator_{S'_i,b}\big)\Big|\ge\frac{n\epsilon}2\bigg)}
  \smallskip
  ...
  \ceq{(1)\hfill\Pr\bigg(\sup_{b\in\V}\Big|\sum_{i=1}^n\sigma_i\,\Indicator_{s_i,b}\Big|\ge\frac{n\epsilon}4\bigg)}
  {=}
